...
<!--  templates from here to the script cdnjs s -->		
		...
		<script type="text/jst" id="leaveTemplate">
				...
				<@ _.each(leaves,function(entry){ @>
					<tr>
						<th scope="row" id="row2"><@= entry.get('leaveType') @></th>
		...
		<script type="text/jst" id="applyTemplate">
			<div class="form">
				<form class="leaveApply" onSubmit="retrun false;">
					<div class="row1">
		...
		<table class="table" id="Table">
			<thead class="thead thead-inverse">
			<tr><th>Start date</th><th>End Date</th><th>Leave Type</th><th>Status</th><th>Comments</th></tr>
			</thead>
